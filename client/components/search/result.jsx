...
const Result = (props) => {
  ...
  return (
    ...
    <a className='search-result' href={ '/school/'+result.slug+'/details' } style={{backgroundImage: 'url(http://res.cloudinary.com/mozaik/image/upload/c_fill,g_auto,h_400,q_auto:low,w_400/'+result.facilitiesImages[0]+'.jpg)'}}>
